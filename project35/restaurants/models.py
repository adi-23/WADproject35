...
class Menu(models.Model):
 	food_itemofrestarent        =models.ForeignKey( Restaurant ,on_delete=models.CASCADE)
    # availability_time =models.CharField(max_length=30)
 	# foof_quantity     =models.CharField(max_length=20)
